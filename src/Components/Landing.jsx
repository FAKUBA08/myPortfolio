...
function Landing() {
  ...
  const words = ['responsive UIs', 'web applications', 'mobile apps', 'user interfaces', 'modern websites'];
useEffect(() => {
     ...
     <div className={Styles.landingAll}>
      ...
      <div className={Styles.container}>
        <div className={Styles.grid}>
         ...
         Fullstack developer with over 3 years of experience building web apps using React, Next.js, Tailwind CSS, and Node.js. Focused on creating performant interfaces and clean, scalable backend solutions
            </p>
            ...
            <div className={Styles.socialLinks}>
              <a 
                ...
                aria-label="GitHub"
              >
                <svg className={Styles.iconMd} fill="currentColor" viewBox="0 0 24 24">
